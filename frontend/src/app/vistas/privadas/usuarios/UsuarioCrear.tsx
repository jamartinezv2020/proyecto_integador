...
export const UsuarioCrear = () => {
  ...
  // *******************************************************************
   ...
   let { nombreUsuario, correoUsuario, estadoUsuario, claveUsuario, nombreImagenUsuario, avatarUsuario, codPerfil, dobleEnlace, objeto,
   } = useFormulario<Usuario>( new Usuario("", "", "", "", new Date(), 0, "", "", new Perfil("", "", 1)) );
   // *******************************************************************
   
      
     // Obtener perfiles a mostrar en el combo
   const obtenerPerfiles = async () => {const resultado = await ServicioPrivado.peticionGET( ApiBack.PERFILES_OBTENER );
