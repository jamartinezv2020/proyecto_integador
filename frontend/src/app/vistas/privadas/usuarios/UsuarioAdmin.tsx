...
export const UsuarioAdmin = () => {
  ...
  const [objUsu, setObjUsu] = useState<Usuario>( new Usuario("", "", "", "", new Date(), 1, "", "", new Perfil("", "", 1)) );
  ...
  const borrarUsuario = async (codigoUsuario: string) => {
    ...
    if (typeof resultado.eliminado === "undefined") {
      ...
      MensajeToastify( "success", "Usuario con correo: " + objUsu.correoUsuario + " ha sido eliminado", 7000 );
    }
    obtenerUsuarios();
  };
  // **************************************************************************
