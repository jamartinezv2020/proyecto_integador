...
export const UsuarioActual = () => {
  ...
  let { nombreUsuario, correoUsuario, estadoUsuario, nombreImagenUsuario, avatarUsuario, codPerfil, dobleEnlace, objeto,
  } = useFormulario<Usuario>( new Usuario("", "", "", "", new Date(), 0, "", "", new Perfil("", "", 1)) );
  // *******************************************************************
  ...
  const enviarFormulario = async (fh: formaHtml) => {
    ...
    if (formulario.checkValidity() === false) {
      ...
      const objetoActualizar = new Usuario( objeto._id, objeto.nombreUsuario, objeto.correoUsuario, "", new Date(), objeto.estadoUsuario,
        nombreImagenUsuario !== "" ? nombreImagenUsuario : nombreimagenTempo, objeto.avatarUsuario, objeto.codPerfil );
