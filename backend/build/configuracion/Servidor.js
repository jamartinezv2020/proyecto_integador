...
const CategoriaRuta_1 = __importDefault(require("../ruta/CategoriaRuta"));
const ProductoRuta_1 = __importDefault(require("../ruta/ProductoRuta"));
const MedicamentoRuta_1 = __importDefault(require("../ruta/MedicamentoRuta"));
const VentaRuta_1 = __importDefault(require("../ruta/VentaRuta"));
...
class Servidor {
    ...
    activarRutas() {
        ...
        this.app.use("/api/privada/categoria", Seguridad_1.default.verificarToken, CategoriaRuta_1.default);
        this.app.use("/api/privada/producto", Seguridad_1.default.verificarToken, ProductoRuta_1.default);
        this.app.use("/api/privada/medicamento", Seguridad_1.default.verificarToken, MedicamentoRuta_1.default);
        this.app.use("/api/privada/cita", Seguridad_1.default.verificarToken, CitaRuta_1.default);
        this.app.use("/api/privada/venta", Seguridad_1.default.verificarToken, VentaRuta_1.default);
    }
    iniciarServidor() {
